 ...
 * Version: 1.2.2-SNAPSHOT - 2016-02-29
 * License: MIT
      ...
      $modalStack.open = function(modalInstance, modal) {
        ...
        if (openedWindows.length() === 0) {
          ...
          if (currBackdropIndex >= 0 && !backdropDomEl) {
            ...
            $document.find('body').eq(0).append(backdropDomEl);
          }
          ...
          $document.find('body').eq(0).append(modalDomEl);
          $document.find('body').eq(0).addClass(OPENED_MODAL_CLASS);
